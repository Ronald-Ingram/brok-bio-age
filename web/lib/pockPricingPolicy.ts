...
export const POCK_QUOTE_DISCLAIMER =
  "Market quote refreshes about every few seconds from public DEX data (not a stock exchange feed). Your $POCK quantity is locked when you start checkout — it does not float up or down while Stripe processes payment.";
...
export const POCK_VOLATILITY_NOTE =
  "In volatile markets the checkout-locked quote can still differ slightly from the next DEX trade. For pure live market settlement, buy $POCK on Solana (on-chain).";
